...
# Tkinter GUIの設定
root = tk.Tk()
root.title("Six Motor Control GUI")
...
for i in range(6):
    ...
    motor_frame.grid(row=row, column=col, padx=10, pady=10, sticky="nsew")
...
command_frame.grid(row=2, column=0, columnspan=3, padx=10, pady=10, sticky="ew")
